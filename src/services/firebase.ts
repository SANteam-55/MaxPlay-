...
const rawDbId = metaEnv.VITE_FIREBASE_DATABASE_ID;
const isRtdbUrl = rawDbId && (rawDbId.startsWith('http://') || rawDbId.startsWith('https://') || rawDbId.includes('firebaseio.com'));
const resolvedDatabaseId = (!rawDbId || isRtdbUrl) 
  ? "ai-studio-maxplay-e5163e97-7cd5-4a42-875c-8b5dce9fd72d" 
  : rawDbId;
