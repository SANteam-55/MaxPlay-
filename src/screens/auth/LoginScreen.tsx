    ...
    <div className="flex h-full w-full flex-col justify-between overflow-y-auto bg-[#0A0A0A] p-6 text-left">
      <div className="pt-6">
        ...
        <button
          ...
          type="button"
          className="flex h-[52px] w-full items-center justify-center gap-3 rounded-full bg-white text-sm font-semibold text-black transition hover:bg-gray-100 cursor-pointer"
        >
