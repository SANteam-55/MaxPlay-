...
- REAL POSTERS: Always use real poster URLs if provided by context. If creating new content without context, use a valid HD placeholder image like "https://images.unsplash.com/photo-1618331835717-801e976710b2?w=800" instead of hallucinating broken TMDB URLs. NEVER invent TMDB hashes.
